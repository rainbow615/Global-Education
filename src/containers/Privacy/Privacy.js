  ...
  return (
    <Root>
      ...
      <CustomContent>
        ...
        <Description>
        This privacy policy ("policy") will help you understand how Mission Critical Protocols ("us", "we", "our") uses and protects the data you provide to us when you visit and use mcprotocols.io (“website”, "service"). 
        ...
        <Description>
          Mission Critical Protocols is committed to securing your data and keeping it confidential. Mission Critical Protocols has done all in its power to prevent data theft, unauthorized access, and disclosure by implementing the latest technologies and software, which help us safeguard all the information we collect online.
        </Description>
        <Title>Our Cookie Policy</Title>
        <Description>
        Once you agree to allow our website to use cookies, you also agree to use the data it collects regarding your online behavior (analyze web traffic, web pages you spend the most time on, and websites you visit).

        The data we collect by using cookies is used to customize our website to your needs. After we use the data for statistical analysis, the data is completely removed
        from our systems.
        ...
        Mission Critical Protocols will not lease, sell or distribute your personal information to any third parties, unless we have your permission. We might do so if the law forces us.
        </Description>
        <BackButton type="link" icon={<ArrowLeftOutlined />} size="large">
          <RouterLink to={'/home'}>Back Home</RouterLink>
        </BackButton>
